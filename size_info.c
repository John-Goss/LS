...
static void	get_size_errorhandling(t_size *size, t_elem *cur)
{
...
static void	get_size_quick(t_size *size, t_elem *cur)
{
	size->linkspace = (int)ft_strlen(ft_itoa(cur->st_nlink)) > size->linkspace
		? (int)ft_strlen(ft_itoa(cur->st_nlink)) : size->linkspace;
